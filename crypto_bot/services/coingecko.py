...
class CoinGeckoHandler(object):
    ...
    def __init__(self):
        ...
        self.supported_coins = [coin["id"] for coin in self.list_coins()]
    ...
    def get_coin(self, coin_id):
        """
        gets the details of the given coin provided
        :param coin_id: str
        :return: dict
        """
        ...
        raise AttributeError(
            f"The coin {coin_id} does not exist in coingecko."
        )
    ...
    def get_coin_market_chart(self, coin_id, currency, days_up_to):
        ...
        :return: list
        """
        return self.coin_manager.get_coin_market_chart_by_id(
            coin_id, currency, days_up_to
        )

    def get_coin_market_date_range(
        self, coin_id, currency, date_from, date_to
    ):
        """
        Get historical market data include price,
        ...
        :return: list
        """
        return self.coin_manager.get_coin_market_chart_range_by_id(
            coin_id, currency, date_from, date_to
        )
    ...
    def get_exchange_status_update(self, exchange_id):
        ...
        :return: dict
        """
        return self.coin_manager.get_exchanges_status_updates_by_id(
            exchange_id
        )
    ...
    def get_coin_contract(self, coin_id, contract_address):
        ...
        :return: dict
        """
        return self.coin_manager.get_coin_info_from_contract_address_by_id(
            coin_id, contract_address
        )

    def get_coin_contract_historical_chart(
        self, coin_id, contract_address, currency, days
    ):
        """
        ...
        :return: list
        """
        return self.coin_manager.get_coin_market_chart_from_contract_address_by_id(
            coin_id, contract_address, currency, days
        )

    def get_coin_contract_historical_range(
        self, coin_id, contract_address, currency, date_from, date_to
    ):
        """
        Get historical market data include price, market cap,
        and 24h volume within a range of timestamp (granularity auto)
        This is the method to use in order to make the implementation in the back-testing.
        ...
        :return: list
        """
        return self.coin_manager.get_coin_market_chart_range_from_contract_address_by_id(
            coin_id, contract_address, currency, date_from, date_to
        )

...
class Command(BaseCommand):
    ...
    the kraken exchange, useful for management, backtesting
    ...
    def add_arguments(self, parser):
        """
        sets the parameters required to parse all data required for
        the symbols required in the exchange.
        :param parser: Argument Parser
        :return: None
        """
        parser.add_argument("symbols", type=str, help="pair symbols XXX/XXX")
        parser.add_argument(
            "--since", type=str, help="Date in format => yyyy-mm-dd"
        )
        parser.add_argument(
            "--timeframe",
            type=str,
    ...
    def handle(self, **options):
        """
        sets all global variables needed for the code to work on
        :param options:  dict
        :return: None
        """
    ...
    def make_date(self):
        """
        create a timestamp for the exchange authentication
        :return: str
        """
        try:
    ...
    def get_history(self):
        """
        gets the historical data of all supported
        symbols for the exchange
        :return: None
        """
        self.stdout.write(
